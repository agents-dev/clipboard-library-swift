...
- Open the picker with large images and long Markdown clips. Type rapidly and verify that lexical matches appear before semantic enrichment, obsolete searches never replace current results, and paste preserves full content.
